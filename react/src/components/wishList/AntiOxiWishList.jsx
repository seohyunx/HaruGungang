...
const AntiOxiWishList = ({antiOxiList, userId, checkedAllItemHandler}) => {
...
<<<<<<< HEAD:templete/src/components/wishList/AntiOxiWishList.jsx
=======
  const [checkedCnt, setCheckedCnt] = useState(0)
>>>>>>> ksy:react/src/components/wishList/AntiOxiWishList.jsx
...
=======
        <h4 className='title font-bold'>항산화</h4>
        <FormGroup>
        <Container>
        <Row className="m-t-40 justify-content-center">
        {antiOxiList.map((item)=>(
...
export default AntiOxiWishList